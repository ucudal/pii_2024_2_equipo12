...
public class PokemonRestrictionCommand
{
    /// <summary>
    /// Esta clase implementa el comando 'pokemonRestriction' del bot. Este comando permite
    /// al jugador añadir restricciones de pokemon especificos a la batalla.
    /// </summary>
